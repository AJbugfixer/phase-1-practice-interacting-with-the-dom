...
// increment/decrement on using button
function minus(){
    let currentCount = parseInt(counter.innerHTML, 10)
    counter.textContent = currentCount - 1
}
...
// "like" for the currentCount, which update
...
// pause which pauses counter, disables all buttons, label change to "resume" when you click "resume" enables all 
